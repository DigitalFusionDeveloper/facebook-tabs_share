...
# un-comment this if you need a private file storage location.  for, eg.  auth
...
#
  if cap_deploy
    ...
    begin
      FileUtils.ln_sf(shared_private_system_path, private_system_path) unless test(?l, private_system_path)
    rescue Object
      raise unless(
